...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lblQrCode.setGeometry(QtCore.QRect(10, 10, 301, 301))
        self.lblQrCode.setStyleSheet("background-color: rgb(255,255,255);")
        self.lblQrCode.setText("")
        self.lblQrCode.setObjectName("lblQrCode")
        self.txtQrData = QtWidgets.QLineEdit(Form)
        self.txtQrData.setGeometry(QtCore.QRect(10, 320, 301, 21))
        self.txtQrData.setObjectName("txtQrData")
        self.btnQrGen = QtWidgets.QPushButton(Form)
        self.btnQrGen.setGeometry(QtCore.QRect(230, 350, 81, 31))
